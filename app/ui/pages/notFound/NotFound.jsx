        ...
        <main className="mx-5 -my-2 flex flex-wrap justify-center">
          ...
          <div className="sm:ml-6">
            <div className="sm:border-l sm:border-gray-200 sm:pl-6">
              <h1 className="text-4xl font-extra bold font-bold text-center tracking-tight sm:text-5xl dark:text-slate-300">Page not found</h1>
              <p className="mt-1 text-sm dark:text-slate-300">Please check the URL in the address bar and try again.</p>
            </div>
